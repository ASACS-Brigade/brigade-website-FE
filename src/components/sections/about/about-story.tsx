...
const girlsSteps = [
  ...
  },
  {
    ...
    body: "Three missions merged into one. Ireland's Cross, Scotland's Lamp, The flame was added to the logo when The Girls’ Brigade came together and England's Crown united into a single crest. June 10th became the International Day of Prayer.",
    rotate: "rotate-3",
  },
  {
    year: "Today",
