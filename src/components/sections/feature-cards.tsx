              ...
              return (
                ...
                >
                  ...
                  <div className="min-w-0 pt-1">
                    <h3 className="text-base font-bold leading-snug text-[#0E2A47] sm:text-lg">
                      {feature.title}
                    </h3>
...
// export default function FeatureCards() {
//   return (
//     <section className="relative z-20 -mt-16 pb-10 sm:-mt-20 md:pb-14">
//       <Container>
//         <div
//           className="
//           overflow-hidden
...
//                     "
//                   >
//                     <Icon strokeWidth={1.8} className="h-8 w-8 sm:h-9 sm:w-9" />
//                   </div>
